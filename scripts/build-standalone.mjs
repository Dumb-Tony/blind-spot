...
const expansion=fs.readFileSync(path.join(dist,'assets/rebel-poses-expansion.png'));
const materials=fs.readFileSync(path.join(dist,'assets/material-atlas.png'));
const assets=`window.BlindSpotAssets={atlas:"data:image/png;base64,${atlas.toString('base64')}",rebels:"data:image/png;base64,${rebels.toString('base64')}",painted:"data:image/png;base64,${painted.toString('base64')}",cohesive:"data:image/png;base64,${cohesive.toString('base64')}",expansion:"data:image/png;base64,${expansion.toString('base64')}",materials:"data:image/png;base64,${materials.toString('base64')}"};\n`;
