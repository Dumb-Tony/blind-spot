...
const assets=`window.BlindSpotAssets={atlas:"data:image/png;base64,${atlas.toString('base64')}",rebels:"data:image/png;base64,${rebels.toString('base64')}",painted:"data:image/png;base64,${painted.toString('base64')}"};\n`;
