...
Wood cracks into uneven splinters; glass shatters into triangular physical shards. Concrete retains its weight but accumulates damage from hard impacts and crumbles into angular rubble. Anchored steel stays fixed. Fragments preserve total mass and inherit the parent's motion, then collide with cameras and other debris. Large wood/concrete pieces can fracture once more; small shards settle without endless subdivision. Removing supports wakes nearby bodies and removes their attachments. Contact strength includes rotation and the other body's mass, so a heavy falling beam matters more than a tiny fast splinter.
